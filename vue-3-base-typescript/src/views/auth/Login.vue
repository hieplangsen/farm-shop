...
import { ISignInResponse } from "@/api/user/interface";
...
const handleLogin = async () => {
	try {
		...
		if (signInResponse && (signInResponse as ISignInResponse).accessToken) {
							...
							<div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
								...
								<div class="flex-auto px-4 lg:px-10 py-10 pt-0">
									...
									<form>
										...
										<div class="cursor-pointer pt-2 w-fit max-w-[130px] select-none" @click="isLogin = !isLogin">
											{{ isLogin ? "Register" : "Login" }}
										</div>
									</form>
								</div>
